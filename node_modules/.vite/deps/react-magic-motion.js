...
// node_modules/react-magic-motion/dist/index.mjs
...
var require_react_is_production_min = __commonJS({
  "../../node_modules/.pnpm/react-is@18.2.0/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
    ...
    var m4 = Symbol.for("react.suspense");
    ...
    exports.isValidElementType = function(a) {
      return "string" === typeof a || "function" === typeof a || a === d || a === f || a === e || a === m4 || a === n || a === t || "object" === typeof a && null !== a && (a.$$typeof === q || a.$$typeof === p || a.$$typeof === g || a.$$typeof === h || a.$$typeof === l || a.$$typeof === u || void 0 !== a.getModuleId) ? true : false;
    };
    exports.typeOf = v;
  }
});
...
var KEYEXCLUDEMESSAGE = "👆 Above element is excluded from being animated";
var FORBIDDENELEMENTMESSAGE = (name) => `Forbidden element encountered: ${name} 
Stopping traversal!`;
var FUNCTIONCOMPONENTMESSAGE = (name) => `Function component encountered: ${name}`;
...
var PREFERSREDUCEDMOTION = "(prefers-reduced-motion: no-preference)";
function usePlaceholderBoxSize(isCardExpanded, rootNode) {
  const [placeholderBoxDimensions, setPlaceholderBoxDimensions] = (0, import_react46.useState)({
    width: 0,
    height: 0
  });
...
function usePrefersReducedMotion() {
  const [prefersReducedMotion2, setPrefersReducedMotion] = (0, import_react46.useState)(false);
  (0, import_react46.useEffect)(() => {
...
function useComponentInactiveLogging(componentName, disabled, isMotionReduced, isLoggingEnabled) {
  (0, import_react46.useEffect)(() => {
...
function isNodeText(node) {
  return typeof node === "string" || Array.isArray(node) && node.every((child) => typeof child === "string");
}
function getIfComponentCanBeConverted(node, nodeType) {
  return !isMotionComponent(nodeType) && !(0, import_react_is.isPortal)(node) && !(0, import_react_is.isProfiler)(node) && !(0, import_react_is.isForwardRef)(node) && !(0, import_react_is.isContextProvider)(node) && !(0, import_react_is.isContextConsumer)(node);
}
function getLayoutValueFromChildren(children) {
  if (isNodeText(children)) {
    return "position";
  }
  return true;
}
var forbiddenComponentKeys = /* @__PURE__ */ new Set([
  "MagicExit",
  "MagicMotion",
  "MagicTabSelect"
]);
function handleForbiddenComponent(node) {
...
function convertChildrenToMotionChildren(children, customProps, nodeInfo) {
  ...
  const animatedChildren = import_react47.Children.map(children, (child) => {
    let node = child;
    if (isLoggingEnabled)
      console.log(node);
    if (!(0, import_react47.isValidElement)(node) || node.key === "exclude") {
      if (isLoggingEnabled && (0, import_react47.isValidElement)(node) && node.key === "exclude")
    ...
    while (typeof node.type === "function") {
      ...
      if (node) {
        ...
        if (forbiddenResult) {
          if (isLoggingEnabled)
            logWarning(FORBIDDENELEMENTMESSAGE(node.key));
          return parent;
        }
      }
      if (!(0, import_react47.isValidElement)(node))
        return node;
    }
    const childType = node.type;
    const nodeRef = (0, import_react_is.isPortal)(node) ? null : node.ref;
    const typeOfNewElement = getIfComponentCanBeConverted(node, node.type) ? m[childType] : node.type;
    const newElemChildren = convertChildrenToMotionChildren(
      node.props.children,
      customProps,
      { isRootNode: false, isLoggingEnabled, depth: depth + 1 }
    );
    const newElem = (0, import_react47.createElement)(
      typeOfNewElement,
      __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, node.props), {
        ref: nodeRef
      }), customProps), {
...
function MagicCard({
  ...
  const rootNode = (0, import_react45.useRef)(null);
  function convertChildrenToMagicCardChildren(nodes, depth) {
    return import_react45.Children.map(nodes, (child, i) => {
      let node = child;
      ...
      const nodeProps = node.props;
      const _a = nodeProps, { className } = _a, restOfProps = __objRest(_a, ["className"]);
      const newElem = (0, import_react45.createElement)(
        m[nodeType],
        __spreadProps(__spreadValues({}, restOfProps), {
          ref: isRoot ? rootNode : void 0,
          className: `${className != null ? className : ""} ${isRoot && isCardExpanded ? "react-magic-motion-card-expanded" : "react-magic-motion-card-condensed"}`,
          layout: getLayoutValueFromChildren(nodeProps.children),
          transition: isRoot ? transition : void 0
        }),
  ...
  return (0, import_jsx_runtime.jsxs)(LazyMotion, { features: domMax, children: [
    motionChildren,
    isCardExpanded && (0, import_jsx_runtime.jsx)(
      "div",
      {
    ...
    isBackgroundFadeEnabled && (0, import_jsx_runtime.jsx)(AnimatePresence, { children: isCardExpanded && (0, import_jsx_runtime.jsx)(
      m.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
...
function MagicMotion({
  ...
  return isMotionReduced || disabled ? children : (0, import_jsx_runtime2.jsx)(LayoutGroup, { children: (0, import_jsx_runtime2.jsx)(LazyMotion, { features: domMax, children: motionChildren }) }, "MagicMotion");
}
function MagicTabSelect({
  children,
  id: id4,
  transition,
  disabled = false
  ...
  if (typeof motionChildren.type === "function") {
    motionChildren = motionChildren.type(
      motionChildren.props
    );
    if (motionChildren === null)
      motionChildren = (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {});
  }
  const childType = motionChildren.type;
  const motionElement = (0, import_react48.createElement)(
    m[childType],
    __spreadProps(__spreadValues({}, motionChildren.props), { layoutId: id4, transition }),
    motionChildren.props.children
  );
  return isMotionReduced || disabled ? children : (0, import_jsx_runtime3.jsx)(LazyMotion, { features: domMax, children: motionElement }, "MagicTabSelect");
}
function MagicExit({
  children,
  initial,
  ...
  const motionChildren = convertChildrenToMotionChildren(
    ...
    {},
    {
      ...
      rootNodeCallback: (rootElem) => {
        const clonedRootElem = (0, import_react49.cloneElement)(rootElem, __spreadProps(__spreadValues({}, rootElem.props), {
          initial,
          animate: animate2,
          exit
        }));
  ...
  return disabled || isMotionReduced ? (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children }) : (0, import_jsx_runtime4.jsx)(AnimatePresence, { mode, children: motionChildren }, "MagicExit");
}
export {
  AnimatePresence,
  AnimateSharedLayout,
...
react-magic-motion/dist/index.mjs:
  (*! Bundled license information:
  ...
  *)
*/
//# sourceMappingURL=react-magic-motion.js.map
